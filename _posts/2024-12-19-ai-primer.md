...
### Avoid: Beware of the Effective Altruist / Accelerationist (e/acc) Crowd
They're not bad, per se. In fact they have a lot of great things to say. But they often speak with vagueness
and memes, implying far more is happening than actually is. This is a really tough one, because a lot of
the top AI labs are saturated with e/acc folk. In a sense, you may just have to learn how to interact with them.
They mostly stay on X, but can be found elsewhere.

A good rule of thumb is to not pay attention until there's a paper. No paper, no tech.
